IF EXISTS(SELECT TABLE_NAME FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME = 'TBL_SHJ_STAFF')               DROP TABLE TBL_SHJ_STAFF;
IF EXISTS(SELECT TABLE_NAME FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME = 'TBL_SHJ_DEPARTMENT')               DROP TABLE TBL_SHJ_DEPARTMENT;
IF EXISTS(SELECT TABLE_NAME FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME = 'TBL_SHJ_COMPANY')               DROP TABLE TBL_SHJ_COMPANY;
